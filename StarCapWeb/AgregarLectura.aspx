            ...
            <div class="card">
                ...
                <div class="card-body">                   
                    ...
                    <div class="form-group">
                        ...
                        <asp:RangeValidator ControlToValidate="horaTxt" MinimumValue="0" MaximumValue="59" EnableClientScript="true" Type="Integer" ErrorMessage="El valor debe ser de 0 a 59" runat="server"></asp:RangeValidator>
